<div class="row" align="center">
    ...
    <div class="col-md-7">
        <div class="input-group"  style="padding: 5px">
            ...
            <input id="title" type="text" class="form-control" placeholder="Title of the movie or event">
        </div><!-- /input-group -->
    </div>
    <div class="col-md-2" style="padding: 5px">
        <button id="buttonSaveMovie" onclick="saveMovie()" type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Save</button>
    </div>
</div>
<div class="row">
    <form class="form"> 
                ...
                <div>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" id="writer" placeholder="Writers or brief Intro to event">
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">   
                            ...
                            <input type="text"  class="form-control" id="awards" placeholder="Awards or Event URL">
                        </div>
                    </div>
                </div>
                    <div>
