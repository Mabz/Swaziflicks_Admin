                            ...
                            success:  (function (ptrPricingTemplate) {
                                ...
                                object.get(cinema, {
                                    success:  (function (ptrCinema) {
                                        ...
                                        // Save Image
                                        convertImgToBase64URL("./images/poster.jpg", function(base64Img) {
                                            
                                            var poster = new Parse.File("poster.jpg", { base64: base64Img });
                                            poster.save().then(function (poster) {
...
function getMoviePoster(imdbID) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            ifrm.setAttribute("src", "./grabPicture.php?filename=" + posterUrl);
            ifrm.setAttribute("width", "0 px");
            ifrm.setAttribute("height", "0 px");
